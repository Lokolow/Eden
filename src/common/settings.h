...
struct Values {
    ...
    // Thermal Protection and Performance Settings
    SwitchableSetting<bool> enable_thermal_throttle{linkage, true, "enable_thermal_throttle",
                                                    Category::System};
    SwitchableSetting<u32> fps_limit{linkage, 30, "fps_limit", Category::Renderer};
    SwitchableSetting<bool> enable_cpu_pinning{linkage, false, "enable_cpu_pinning",
                                               Category::System};
    SwitchableSetting<bool> enable_adaptive_resolution{linkage, false, "enable_adaptive_resolution",
                                                       Category::Renderer};
    SwitchableSetting<bool> enable_vram_gc{linkage, true, "enable_vram_gc",
                                           Category::Renderer};
    SwitchableSetting<u32> texture_cache_limit_mb{linkage, 1024, "texture_cache_limit_mb",
                                                  Category::Renderer};
